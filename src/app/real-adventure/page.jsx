            ...
            <section className='py-4'>
                <div className="container mx-auto">
                    <div className="flex py-4 justify-between">
                        <h2 className='text-[24px] font-bold uppercase'>Real Adventures</h2>
                        <Link href=""><div className='flex gap-2 items-center'><FiShare2 className='size-[20px] text-blue-700' />Share it</div></Link>
                    </div>
                    <div>
                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>With its diverse landscapes, towering peaks, and rich cultural heritage, Nepal, the land of the majestic Himalayas, has firmly established itself as a top destination, offering a paradise for adventure lovers.</p>



                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>We invite adventure lovers to join our available trekking and active Small Group Tours or arrange an exclusive trip with us for your families and friends. Besides mountain trekking, challenge yourself with white-water rafting in the raging rivers, paragliding over stunning landscapes, or bungee jumping from towering suspension bridges. Explore the rugged terrain on thrilling mountain biking trails or go canyoning in the cascading waterfalls.</p>

                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>Alongside trekking, discover ancient temples and monasteries nestled amidst the mountains, witness vibrant festivals and rituals and interact with friendly locals who embody the spirit of the Himalayas.</p>

                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>At Thamel Travels and Tours, we organize trekking and active trips with experienced guides, and well-planned itineraries, and ensure your safety throughout the journey.</p>

                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>Trekking in Nepal is a once-in-a-lifetime experience that takes you through breathtaking trails, remote villages, and awe-inspiring mountain vistas. From the world-famous Everest Base Camp Trek to the Annapurna Circuit Trek, there are routes suitable for both beginners and seasoned trekkers. Explore pristine valleys, cross high mountain passes, and immerse yourself in the unique Himalayan culture along the way.</p>
