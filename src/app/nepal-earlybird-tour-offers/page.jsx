            ...
            <section className='py-4'>
                <div className="container mx-auto">
                    <div className="flex py-4 justify-between">
                        <h2 className='text-[24px] font-bold uppercase'>EarlyBird Offers</h2>

                        <Link href=""><div className='flex gap-2 items-center'><FiShare2 className='size-[20px] text-blue-700' />Share it</div></Link>
                    </div>
                    <div>
                        <h2 className='text-[20px] text-black py-3 font-bold'>Earlybird Offer Price Validity</h2>

                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>EarlyBird offer prices are valid until August 30, 2023. Trips booked by August 30, 2023, will enjoy special discounts as mentioned in the tour packages.</p>

                        <h2 className='text-[20px] text-black py-3 font-bold'>Earlybird Cancellation Policy</h2>

                        <p className='py-4 text-[16px] font-[500] text-[#555454]'>The cancellation policy is as simple as possible. We have offered very relaxing and honest cancellation policies; please read the <Link href="/terms-and-conditions" ><span className='text-blue-400 hover:underline'>cancellation policies</span></Link>.</p>
